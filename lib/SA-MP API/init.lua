...
local offset = {
	...
	--function by SEVEN
	fnShowDialog		  = {['0_3_7-R1'] = 0x6FA50, ['0_3_DL-R1'] = 0x6FA50};
};
...
-- This function made by: SEVEN
function module.getLocalUsername()
	local this = module.Get().pBase.pPools.pPlayer
	if ( this == 0x0 ) then return end
	return ffi.string(this.strLocalPlayerName)
end

function module.getLocalPlayerId()
	local this = module.Get().pBase.pPools.pPlayer
	if ( this == 0x0 ) then return end
	return this.sLocalPlayerID
end

function module.getLocalPlayerPing()
	local this = module.Get().pBase.pPools.pPlayer
	if ( this == 0x0 ) then return end
	return this.iLocalPlayerPing
end

function module.getLocalPlayerScore()
	local this = module.Get().pBase.pPools.pPlayer
	if ( this == 0x0 ) then return end
	return this.iLocalPlayerScore
end

function module.getMaxPlayerId()
	local this = module.Get().pBase.pPools.pPlayer
	if ( this == 0x0 ) then return end
	return this.ulMaxPlayerID
end

function module.getServerIp()
	local this = module.Get().pBase
	if ( this == 0x0 ) then return end
	return ffi.string(this.szIP)
end

function module.getServerHostname()
	local this = module.Get().pBase
	if ( this == 0x0 ) then return end
	return ffi.string(this.szHostname)
end

function module.getServerPort()
	local this = module.Get().pBase
	if ( this == 0x0 ) then return end
	return this.ulPort
end

function module.getGameState()
	local this = module.Get().pBase
	if ( this == 0x0 ) then return end
	return this.iGameState
end
-- 0.3 functions!
function module.isChatOpen()
	local this = module.Get().pChatInput.pDXUTEditBox
	if ( this == 0x0 ) then return end
	return this.bIsChatboxOpen
end

function module.setLocalUsername(pLocalPlayerName)
	local this = module.Get().pBase.pPools.pPlayer
	if ( this == 0x0 ) then return end
	if pLocalPlayerName == nil then return end
	this.strLocalPlayerName = pLocalPlayerName
end

function module.isScoreboardOpen()
	local this = module.Get().pScoreboard
	if ( this == 0x0 ) then return end
	return this.iIsEnabled
end

function module.isAnyDialogOnScreen()
...
function module.getDialogId()
	local this = module.Get().pRecentDialog
	if ( this == 0x0 ) then return end
	return this.uiDialogID
end

function module.getDialogStyle()
	local this = module.Get().pRecentDialog
	if ( this == 0x0 ) then return end
	return this.iType
end

function module.getDialogCaption()
	local this = module.Get().pRecentDialog
	if ( this == 0x0 ) then return end
	return ffi.string(this.szCaption)
end

function module.getDialogText()
	local this = module.Get().pRecentDialog
	if ( this == 0x0 ) then return end
	return ffi.string(this.pText)
end

function module.isPlayerConnected(playerId)
	local this = module.Get().pBase.pPools.pPlayer
	if ( this == 0x0 ) then return end
	if playerId == nil then return end
	return this.iIsListed[playerId]
end
